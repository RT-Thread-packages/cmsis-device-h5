...
src = [os.path.join(cwd, 'Source', 'Templates', 'system_stm32h5xx.c')]

# Map microcontroller units (MCUs) to their corresponding startup files
mcu_startup_files = {
    'STM32H503xx': 'startup_stm32h503xx.s',
    'STM32H562xx': 'startup_stm32h562xx.s',
    'STM32H563xx': 'startup_stm32h563xx.s',
    'STM32H573xx': 'startup_stm32h573xx.s',
}
...
group = DefineGroup('STM32H5-CMSIS', src, depend=['PKG_USING_STM32H5_CMSIS_DRIVER'], CPPPATH=path)
